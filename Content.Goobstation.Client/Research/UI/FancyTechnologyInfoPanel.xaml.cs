...
public sealed partial class FancyTechnologyInfoPanel : Control
{
    ...
    public FancyTechnologyInfoPanel(TechnologyPrototype proto, bool hasAccess, ResearchAvailability availability, ResearchTechnologyLockReason lockReason, SpriteSystem sprite, IPrototypeManager prototype, TechnologyDatabaseComponent? database = null) // RW-Edit
    {
        ...
        InitializePrerequisites(proto, research, sprite, lockReason, prototype); // RW-Edit
    ...
    private void InitializePrerequisites(TechnologyPrototype proto, ResearchSystem research, SpriteSystem sprite, ResearchTechnologyLockReason lockReason, IPrototypeManager prototype) // RW-Edit
    {
        // RW-Edit-Start
