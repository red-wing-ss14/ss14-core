...
namespace Content.Server.Database.Migrations.Sqlite
{
    ...
    [Migration("20260724162806_RemoveOOCAndTagsLinks")]
    partial class RemoveOOCAndTagsLinks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Content.Server.Database.AmourBooster", b =>
                {
                    ...
                    b.ToTable("amour_boosters", (string)null);
                });

            modelBuilder.Entity("Content.Server.Database.AmourClientRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                    ...
                    b.HasKey("Id")
                        .HasName("PK_amour_client_cache");

                    b.HasIndex("ClientId")
                        .IsUnique()
                        .HasDatabaseName("IX_amour_client_cache_client_id");

                    b.ToTable("amour_client_cache", (string)null);
                });
            ...
            modelBuilder.Entity("Content.Server.Database.RwBrainrotTrigger", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                    ...
                    b.HasKey("Id")
                        .HasName("PK_rw_brainrot_triggers");

                    b.HasIndex("Trigger")
                        .IsUnique()
                        .HasDatabaseName("IX_rw_brainrot_triggers_trigger");

                    b.ToTable("rw_brainrot_triggers", (string)null);
                });
            ...
            modelBuilder.Entity("Content.Server.Database.AmourBooster", b =>
                {
                    b.HasOne("Content.Server.Database.Player", "Player")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_amour_boosters_player_player_id1");
