...
Вы можете поставить свой ник после символа :cl:, чтобы изменить ник, который будет отображаться в журнале изменений (в противном случае будет использоваться ник вашего аккаунта GitHub). Например: ":cl: PuroSlavKing".
...
<!-- Не забудьте убрать стрелки, чтобы список изменений отображался, если вы считаете, что он нужен.
