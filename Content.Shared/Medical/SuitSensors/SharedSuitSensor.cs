...
{
    public SuitSensorStatus(NetEntity ownerUid, NetEntity suitSensorUid, string name, string job, string jobIcon, List<string> jobDepartments, SuitSensorMode sensorMode) // RW-Edit
    {
        OwnerUid = ownerUid;
...
public static class SuitSensorConstants
{
    ...
    public const string NET_SUIT_SENSOR_MODE = "mode"; // RW
