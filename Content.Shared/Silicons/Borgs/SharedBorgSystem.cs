...
public abstract partial class SharedBorgSystem : EntitySystem
{
    ...
    [Dependency] protected readonly SharedRoleSystem _roles = default!;
    [Dependency] protected readonly SharedMindSystem _mind = default!;
    [Dependency] protected readonly SharedAppearanceSystem _appearance = default!;
    [Dependency] protected readonly IGameTiming _timing = default!;
    [Dependency] protected readonly MovementSpeedModifierSystem _movementSpeedModifier = default!;
    ...
    [Dependency] protected readonly IConfigurationManager _configuration = default!;
    ...
    [Dependency] protected readonly SharedHandheldLightSystem _handheldLight = default!;
    [Dependency] protected readonly SharedAccessSystem _access = default!;
    [Dependency] protected readonly SharedAudioSystem _audio = default!;
    [Dependency] protected readonly SharedUserInterfaceSystem _ui = default!; // Goob
    ...
    private void OnMindAdded(Entity<BorgChassisComponent> chassis, ref MindAddedMessage args)
    {
        ...
        if (TryComp<BorgSwitchableTypeComponent>(chassis, out var switchable))
            ...
            {
                chassis.Comp.CanOpenSelfUi = true;
                _ui.TryOpenUi(chassis.Owner, BorgSwitchableTypeUiKey.SelectBorgType, chassis);
            }
    ...
    private void OnChassisInteractUsing(Entity<BorgChassisComponent> chassis, ref AfterInteractUsingEvent args)
    {
            ...
            _whitelist.IsWhitelistPassOrNull(chassis.Comp.BrainWhitelist, used))
        {
            ...
            if (CanActivate(chassis))
                SetActive(chassis, true, args.User);
        }
        // Corvax-Next-AiRemoteControl-End
    }
