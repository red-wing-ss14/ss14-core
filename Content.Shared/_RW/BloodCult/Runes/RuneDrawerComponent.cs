...
public sealed partial class RuneDrawerComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier StartDrawingSound = new SoundPathSpecifier("/Audio/_RW/BloodCult/butcher.ogg");

    public SoundSpecifier EndDrawingSound = new SoundPathSpecifier("/Audio/_RW/BloodCult/blood.ogg");
}
