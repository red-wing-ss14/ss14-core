...
using Content.Shared._RW.BloodCult.Items.VoidTorch;
using Robust.Client.GameObjects;

namespace Content.Client._RW.BloodCult.Items.VoidTorch;
...
public sealed class VoidTorchSystem : VisualizerSystem<VoidTorchComponent>
{
        ...
        ref AppearanceChangeEvent args)
    {
        ...
        _lightBehavior.StartLightBehaviour((uid, lightBehaviour),
            state ? component.TurnOnLightBehaviour : component.TurnOffLightBehaviour);
    }
}
