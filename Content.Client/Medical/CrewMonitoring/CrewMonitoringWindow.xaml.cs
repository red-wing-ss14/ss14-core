...
using Content.Shared.Roles;  // RW: sorting by departments
...
public sealed partial class CrewMonitoringWindow : FancyWindow
{
    ...
    public void ShowSensors(List<SuitSensorStatus> sensors, EntityUid monitor, EntityCoordinates? monitorCoords, bool isEmagged) // RW-Edit: Emag monitoring
    {
        ClearOutDatedData();
