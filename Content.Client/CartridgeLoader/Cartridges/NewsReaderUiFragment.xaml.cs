...
*/
    ...
    public void UpdateState(NewsArticle article, int targetNum, int totalNum, bool notificationOn)
    {
        ...
        var content = SafeMarkup.SanitizeNewsArticle(article.Content); // Orion
        PageText.SetMessage(FormattedMessage.FromMarkupPermissive(content), SafeMarkupTags.NewsArticle); // Orion-Edit
        ...
        Author.SetMessage(FormattedMessage.FromMarkupPermissive(author), SafeMarkupTags.NewsArticle); // Orion-Edit
