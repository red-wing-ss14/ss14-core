...
*/
    ...
    public void UpdateState(NewsArticle article, int targetNum, int totalNum, bool notificationOn)
    {
        ...
        var content = SafeMarkup.SanitizeNewsArticle(article.Content); // RW
        PageText.SetMessage(FormattedMessage.FromMarkupPermissive(content), SafeMarkupTags.NewsArticle); // RW-Edit
        ...
        Author.SetMessage(FormattedMessage.FromMarkupPermissive(author), SafeMarkupTags.NewsArticle); // RW-Edit
