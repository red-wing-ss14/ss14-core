...
namespace Content.Client.Stylesheets
{
    ...
    public sealed class StyleNano : StyleBase
    {
        ...
        public StyleNano(IResourceCache resCache) : base(resCache)
        {
            ...
            // Monotone (filled)
            var monotoneButtonTex = resCache.GetTexture("/Textures/Interface/Nano/button.svg.96dpi.png");
            var monotoneFilledButton = new StyleBoxTexture(monotoneButton)
            {
                Texture = monotoneButtonTex,
            };

            var monotoneFilledButtonOpenLeft = new StyleBoxTexture(monotoneButton)
            {
                Texture = new AtlasTexture(monotoneButtonTex, UIBox2.FromDimensions(new Vector2(10, 0), new Vector2(14, 24))),
            };
            ...
            {
                Texture = new AtlasTexture(monotoneButtonTex, UIBox2.FromDimensions(new Vector2(0, 0), new Vector2(14, 24))),
            };
            ...
            {
                Texture = new AtlasTexture(monotoneButtonTex, UIBox2.FromDimensions(new Vector2(10, 0), new Vector2(3, 24))),
            };
...
// ListContainer
                ...
                new StyleRule(
                    new SelectorElement(typeof(MenuButton), new[] {StyleClassRedTopButton}, null, new[] {ContainerButton.StylePseudoClassHover}),
                    new[]
                    {
