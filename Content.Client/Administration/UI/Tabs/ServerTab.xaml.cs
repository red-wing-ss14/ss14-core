...
namespace Content.Client.Administration.UI.Tabs
{
    ...
    public sealed partial class ServerTab : Control
    {
        ...
        public ServerTab()
        {
            ...
            _config.OnValueChanged(AmourCCVars.OocAutoToggleEnabled, AutoOocEnabledChanged, true); // Amour
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            if (disposing)
            {
                ...
                _config.UnsubValueChanged(AmourCCVars.OocAutoToggleEnabled, AutoOocEnabledChanged); // Amour
