...
namespace Content.Client.PDA
{
    ...
    public sealed partial class PdaMenu : PdaWindow
    {
        ...
        [Dependency] private readonly IEntityManager _entityManager = default!; // Orion
        ...
        public PdaMenu()
        {
            ...
            StationRealTimeButton.OnPressed += _ =>
            {
                if (TryGetStationTime(out var time))
                    _clipboard.SetText(time.ToString("hh\\:mm"));
            };

            StationDateButton.OnPressed += _ =>
            {
                if (TryGetStationDate(out var date))
                    _clipboard.SetText(date.ToString("dd.MM.yyyy"));
            };
            // Orion-End
...
*/
        ...
        // Orion-Start
        private bool TryGetStationTime(out TimeSpan time)
        {
            time = TimeSpan.Zero;
        ...
        private bool TryGetStationDate(out DateTime date)
        {
