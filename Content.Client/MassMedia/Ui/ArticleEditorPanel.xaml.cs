...
*/
    ...
    private void OnPreview(BaseButton.ButtonEventArgs eventArgs)
    {
        ...
        var articleBody = SafeMarkup.SanitizeNewsArticle(Rope.Collapse(ContentField.TextRope)); // RW-Edit
        PreviewLabel.SetMessage(FormattedMessage.FromMarkupPermissive(articleBody), SafeMarkupTags.NewsArticle); // RW-Edit
    }
