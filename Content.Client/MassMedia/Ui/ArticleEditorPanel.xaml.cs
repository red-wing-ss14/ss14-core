...
*/
    ...
    private void OnPreview(BaseButton.ButtonEventArgs eventArgs)
    {
        ...
        var articleBody = SafeMarkup.SanitizeNewsArticle(Rope.Collapse(ContentField.TextRope)); // Orion-Edit
        PreviewLabel.SetMessage(FormattedMessage.FromMarkupPermissive(articleBody), SafeMarkupTags.NewsArticle); // Orion-Edit
    }
