...
public sealed class NukeSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<NukeDiskComponent, Content.Server.Kitchen.Components.BeingMicrowavedEvent>(OnMicrowaved);
    }
    ...
    /// </summary>
    private void OnMicrowaved(Entity<NukeDiskComponent> ent, ref Content.Server.Kitchen.Components.BeingMicrowavedEvent args)
    {
