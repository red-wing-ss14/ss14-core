...
public sealed class IdCardSystem : SharedIdCardSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<IdCardComponent, Content.Server.Kitchen.Components.BeingMicrowavedEvent>(OnMicrowaved);
    }

    private void OnMicrowaved(EntityUid uid, IdCardComponent component, Content.Server.Kitchen.Components.BeingMicrowavedEvent args)
    {
