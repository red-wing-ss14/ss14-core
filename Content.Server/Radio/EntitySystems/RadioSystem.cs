...
public sealed partial class RadioSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<IntrinsicRadioTransmitterComponent, Content.Server.Chat.Systems.EntitySpokeEvent>(OnIntrinsicSpeak);
    ...
    private void OnIntrinsicSpeak(EntityUid uid, IntrinsicRadioTransmitterComponent component, Content.Server.Chat.Systems.EntitySpokeEvent args)
    {
