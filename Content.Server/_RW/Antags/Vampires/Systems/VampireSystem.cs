...
using Content.Server._RW.Antags.Vampires.Components;
using Content.Server.Atmos.EntitySystems;
using Content.Server.Body.Systems;
using Content.Goobstation.Shared.Overlays;
using Content.Server.Objectives.Components;
using Content.Server.Objectives.Systems;
using Content.Shared._RW.Antags.Vampires;
using Content.Shared._RW.Antags.Vampires.Components.Classes;
using Content.Shared._RW.Antags.Vampires.Prototypes;
using Content.Shared.Eye.Blinding.Components;
using Content.Shared._RW.Antags.Vampires.Components;
...
namespace Content.Server._RW.Antags.Vampires.Systems;
...
public sealed partial class VampireSystem : EntitySystem
{
    ...
    {
        _ui.SetUi(uid, VampireClassUiKey.Key, new InterfaceData("VampireClassBui", interactionRange: 0f));
        _ui.SetUi(uid, VampireLocateUiKey.Key, new InterfaceData("VampireLocateBui", interactionRange: 0f));
