...
using Content.Server._RW.GameTicking.Rules.Components;
...
namespace Content.Server._RW.GameTicking.Rules;
...
public sealed partial class VampireRuleSystem : GameRuleSystem<VampireRuleComponent>
{
    ...
    public readonly SoundSpecifier BriefingSound = new SoundPathSpecifier("/Audio/_RW/Ambience/Antag/vampire_start.ogg");
    ...
    public bool MakeVampire(EntityUid target, VampireRuleComponent rule)
    {
        ...
        // RW edit: Goob does not expose RoleBriefingComponent in this fork.
