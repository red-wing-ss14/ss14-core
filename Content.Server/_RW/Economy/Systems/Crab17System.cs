...
using Content.Shared._RW.Economy.Components;
using Content.Server._RW.Mood;
...
using Content.Shared._RW.Economy;
...
namespace Content.Server._RW.Economy.Systems;
    ...
    private void AdvanceStartup(Entity<Crab17MarketComponent> ent)
    {
        switch (ent.Comp.StartupStage)
        {
            ...
            case 1:
                ...
                break;
            case 2:
                _audio.PlayPvs("/Audio/_RW/Machines/twobeep_high.ogg", ent);
