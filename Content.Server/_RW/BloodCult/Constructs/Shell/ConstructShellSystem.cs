...
using Content.Server._RW.BloodCult.Constructs.SoulShard;
...
namespace Content.Server._RW.BloodCult.Constructs.Shell;
    ...
    private void OnGetVerbs(Entity<ConstructShellComponent> shell, ref GetVerbsEvent<ExamineVerb> args)
    {
        ...
        args.Verbs.Add(new ExamineVerb
        {
            ...
            Icon = new SpriteSpecifier.Texture(
                new ResPath("/Textures/_RW/BloodCult/Entities/Items/construct_shell.rsi")),
            Act = action
        });
    }
