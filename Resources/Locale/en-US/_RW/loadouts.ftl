# RW - Fluff Loadouts
loadout-group-amour-personal-head = Fluff: Головной убор
loadout-group-amour-personal-mask = Fluff: Маска
loadout-group-amour-personal-neck = Fluff: Накидка
...
loadout-group-amour-boosty-trinkets = DJ

# RW - Loadout Effect Messages
loadout-effect-boosty-no-session = Требуется авторизация
loadout-effect-boosty-no-subscription = Требуется подписка Boosty
loadout-effect-boosty-tier-required = Требуется подписка Boosty
loadout-effect-boosty-higher-tier-required = Требуется уровень {$required} (ваш: {$current})
loadout-effect-job-restriction = Этот предмет недоступен для вашей текущей должности.
loadout-effect-username-denied = Я тебе ебало сломаю3
