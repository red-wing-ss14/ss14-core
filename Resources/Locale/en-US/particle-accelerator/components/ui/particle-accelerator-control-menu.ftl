...
particle-accelerator-control-menu-status-unknown = [font="Monospace"][color=red]Unknown[/color][/bold][/font]
particle-accelerator-control-menu-status-operational = [font="Monospace"][color=green]Operational[/color][/bold][/font]
particle-accelerator-control-menu-status-incomplete = [font="Monospace"][color=red]Incomplete[/color][/bold][/font]
