...
bounty-description-artifact = НаноТрейзен находится в затруднительном положении из-за кражи артефактов с планет, не практикующих космические полёты. Верните один, и мы выплатим за него компенсацию.
bounty-description-baseball-bat = На Центральное Командовании началась бейсбольная лихорадка! Будьте добры отправить им несколько бейсбольных бит, чтобы руководство могло исполнить свою детскую мечту.
...
bounty-description-donk-pocket = Отзыв о безопасности потребителей: Предупреждение. Донк-покеты, произведённые в прошлом году, содержат опасные биоматериалы ящериц. Немедленно верните продукты Центральному Командованию.
...
bounty-description-handcuffs = На Центральное Командование прибыл большой поток беглых заключённых. Сейчас самое время отправить запасные наручники (или стяжки).
...
bounty-description-pancake = НаноТрейзен считает всех своих сотрудников одной дружной семьёй. А вы знаете, что любят семьи? Блины. Отправьте дюжину.
...
bounty-description-pie = 3.14159? Нет! Оператор ЦК хочет покушать ПИрогов! Отправьте ему один.
...
bounty-description-research-disk = Оказывается, эти недоумки из отдела исследований тратят всё своё время на приобретение оборудования для уборки. Отправьте несколько исследований на Центральное Командование, чтобы мы могли действительно получить то, что нам нужно.
...
bounty-description-soap = Из ванных комнат Центрального Командования пропало мыло, и никто не знает, кто его взял. Замените его и станьте героем, в котором мы так давно нуждались.
...
bounty-description-syringe = Группе НаноТрейзен по борьбе с наркотиками нужны шприцы, чтобы распространять их среди малообеспеченных слоёв населения. Помогите некоторым людям сохранить работу.
bounty-description-toolbox = На Центральном Командовании не хватает робастности. Поторопитесь и поставьте несколько ящиков с инструментами в качестве решения проблемы.
...
bounty-description-trash = Недавно у группы уборщиков закончился мусор для уборки, а без мусора Центральное Командование собирается уволить их, чтобы сократить расходы. Отправьте партию мусора, чтобы сохранить им работу, и они дадут вам небольшую компенсацию.
...
bounty-description-labeler = Из-за бюрократической ошибки наш сортировочный центр чуть не отправил несколько сотен ящиков моркови в поселение ящеров. Нам срочно нужны дополнительные этикетировщики, чтобы навести порядок на складе.
bounty-description-warm-cloth = Строительная бригада ящеров не может восстановить электропитание на своей станции и замерзает. Нужно прислать им хоть какую-нибудь тёплую одежду.
...
bounty-description-chili = Сегодня на ЦК Четверг Чили, но, ну... Некоторые из нас забыли его приготовить. Пожалуйста, выручите нас.
bounty-description-rollerskates = Служба безопасности ЦК предложила новую стратегию, которая поможет офицерам одерживать верх в пеших погонях. Пришлите им парочку, чтобы они поняли, насколько это ужасная идея.
...
bounty-description-steak = Повар-вегетарианец отказывается готовить нам что-нибудь из мяса, и ящеры начинают беспокоиться. Не могли бы вы тайно доставить нам несколько стейков, чтобы они остались довольны?
...
bounty-description-medkit-box = Центральное Командование ставит спектакль в больнице, в связи с чем нуждается в реквизите. Просто пришлите нам несколько пустых аптечек, и спектакль состоится!
...
bounty-description-food = После нашествия крысиного короля соседняя станция ящеров осталась без еды. Необходима большая партия мясных блюд.
