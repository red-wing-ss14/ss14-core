ent-BaseWeaponSniper = БазоваяВинтовка
    .desc = Дерзай — налетай, целься и стреляй.
ent-BaseWeaponSniperMagazine = БазовыйМагазинВинтовки
    .desc = Тутти-шутти, пиу-пиу бам.
ent-WeaponSniperMosin = Кардашёв-Мосин
    .desc = Оружие охоты, или бесконечной окопной войны. Использует патроны калибра 7.62мм винтовочный.
    .suffix = Винтовка
