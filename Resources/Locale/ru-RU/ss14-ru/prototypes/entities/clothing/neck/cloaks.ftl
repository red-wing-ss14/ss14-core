ent-ClothingNeckCloakCentcom = плащ представителя ЦК
...
ent-ClothingNeckCloakGreenCe = зелёный плащ старшего инженера
    .desc = Белый плащ с жёлтыми и синими узорами, который выдаётся тем, кто доказал, что владеет точным инженерным искусством.
