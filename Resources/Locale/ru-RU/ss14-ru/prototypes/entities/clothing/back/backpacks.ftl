...
ent-ClothingBackpackMime = рюкзак мима
    .desc = Молчаливый рюкзак, созданный для молчаливых работников. Тихонечко Ко.
...
ent-ClothingBackpackCluwne = трясушкин фон трясхертон
    .desc = Это рюкзак, изготовленный компанией "Жонк! Ко.".
    .suffix = Неснимаемый
...
ent-ClothingBackpackDebug2 = большой странный рюкзак
    ...
    .suffix = Дебаг
ent-ClothingBackpackDebug3 = ЗАПРЕЩЁННЫЙ рюкзак
    .desc = { ent-ClothingBackpackDebug.desc }
    .suffix = Дебаг
