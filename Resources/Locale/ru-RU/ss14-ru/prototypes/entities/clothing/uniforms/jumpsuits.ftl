...
ent-ClothingUniformJumpsuitCentcomAgent = комбинезон агента ЦК
    .desc = Костюм, который носят юристы Центрального Командования. Пахнет подгоревшим кофе.
ent-ClothingUniformJumpsuitCentcomOfficial = костюм офицера ЦК
    .desc = Это комбинезон, который носят офицеры Центрального Командования высшего звена.
ent-ClothingUniformJumpsuitCentcomOfficer = водолазка ЦК
    .desc = Повседневная, но элегантная водолазка зелёного цвета, используемая офицерами Центрального Командования. От неё веет алоэ.
...
ent-ClothingUniformJumpsuitERTChaplain = униформа священника ОБР
    .desc = Специальный костюм, созданный для элитных священников Центрального Командования.
ent-ClothingUniformJumpsuitERTEngineer = униформа инженера ОБР
    .desc = Специальный костюм, созданный для элитных инженеров Центрального Командования.
ent-ClothingUniformJumpsuitERTJanitor = униформа уборщика ОБР
    .desc = Специальный костюм, созданный для элитных уборщиков Центрального Командования.
ent-ClothingUniformJumpsuitERTLeader = униформа лидера ОБР
    .desc = Специальный костюм, созданный для настоящей элиты Центрального Командования.
ent-ClothingUniformJumpsuitERTMedic = униформа медика ОБР
    .desc = Специальный костюм, созданный для элитных медиков Центрального Командования.
ent-ClothingUniformJumpsuitERTSecurity = униформа офицера безопасности ОБР
    .desc = Специальный костюм, созданный для элитных офицеров безопасности Центрального Командования.
