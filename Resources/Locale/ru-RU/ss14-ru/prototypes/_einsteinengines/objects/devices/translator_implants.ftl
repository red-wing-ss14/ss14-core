...
ent-DraconicTranslatorImplant = имплант "переводчик Драконовый"
    .desc = Имплант, дающий возможность говорить с драконами! А также позволяет общаться с ящеролюдами.
...
ent-MofficTranslatorImplant = имплант "переводчик Ткачий"
    .desc = Имплант, созданный для одомашнивания таракамолей. Впоследствии позволяет общаться с нианами.
...
ent-ChittinTranslatorImplant = имплант "переводчик Хитин"
    .desc = Имплант, дающий возможность понимать и говорить на Хитине.
