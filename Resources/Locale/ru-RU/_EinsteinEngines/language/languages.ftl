...
language-Draconic-name = Драконовый
...
language-SolCommon-description = Уходящий корнями в китайский, общесолнечный стал официальным языком Солнечной Федерации - объединяющим все колонии. На нём говорят чиновники, его преподают в школах, и используют те, кто чувствует связь с Солнечной Федерацией и ОПЗ.
...
language-Sign-description = Стандартный межгалактический язык жестов, распространённый среди немых и глухих.
...
language-Chittin-name = Хитинновый
...
language-Zombie-description = Гортанные стоны и голодное мычание, смысл которых понимают только заражённые.
