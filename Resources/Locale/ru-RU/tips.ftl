...
tips-dataset-84 = Будучи врачом, будьте осторожны при помещении ящеров в криокапсулы. Они получат много дополнительного урона от холода, но вы всегда сможете смягчить это с помощью мази или лепоразина.
...
tips-dataset-139 = Обязательно протирайте незаконные имплантеры мылом или тряпкой после их использования! Детективы могут сканировать использованные имплантеры на предмет наличия следов ДНК, но только в том случае, если те не были тщательно вытерты.
