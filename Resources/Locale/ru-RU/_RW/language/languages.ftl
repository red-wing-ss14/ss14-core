...
language-CorporateCodespeak-name = Корпоративный кодовый язык
language-CorporateCodespeak-description = Корпоративные диалекты, поданные в виде шифра, используемые НаноТрейзен.
