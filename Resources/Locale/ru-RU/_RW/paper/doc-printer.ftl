...
doc-text-printer-report-employee-performance =
   ...
   ⠀[color=#1b487e]░░░░██░░░████░███[/color]
    ...
    Я, (ФИО), в должности (полное наименование должности), в ходе исполнения своих обязанностей выполнил положенный объем работ. Прошу принять результат работ Главой отдела (наименование отдела).
...
doc-text-printer-letter-resignation =
    ...
    Я, (ФИО), в текущей должности (полное наименование должности), хочу уволиться с отдела (название отдела) по причине (причина).
...
doc-text-printer-shuttle-registration-request =
    ...
    Я, (ФИО), в должности (полное наименование должности), прошу провести регистрацию шаттла в системе НаноТрейзен для идентификации.
    Размеры шаттла:
...
doc-text-printer-sentence =
        ...
        (суммарный срок, пожизненное заключение, либо приговор к казни)
...
doc-text-printer-note-beginning-military-actions =
    ...
    Неуважаемые корпоративные крысы НаноТрейзен! Синдикат официально объявляет о начале военных действий с вами, а также о начале операции по вашему истреблению.
