...
uplink-pistol-viper-desc = Легкий и компактный пистолет, который позволяет наносить удары, превышающие его весовую категорию. Может переключаться между полуавтоматическим и полностью автоматическим режимом стрельбы. Использует 9мм авто.
...
uplink-revolver-python-desc = Брутально простой, эффективный и громкий револьвер Синдиката. Поставляется с бронебойными патронами. Вмещает 6 патронов калибра .45 магнум.
...
uplink-pistol-cobra-desc = Полуавтоматический пистолет с встроенным глушителем, не оставляющий следов. Использует .25.
uplink-rifle-mosin-name = Старая винтовка
uplink-rifle-mosin-desc = Затворная винтовка, повидавшая не одну войну. Не современная ни по каким стандартам, заряжается вручную и имеет ужасную отдачу, но зато дешёвая. Вмещает 10 патронов 30-го калибра.
...
uplink-mosin-ammo-name = Коробка патронов (7.62мм винтовочные)
uplink-mosin-ammo-desc = Коробка с 40 патронами для резервной винтовки.
...
uplink-uplink-implanter-desc = Незаметно заказывайте снаряжение без использования ПДА. Глотайте телекристаллы, чтобы пополнить аплинк.
...
uplink-knives-kit-desc = Набор из 4 фирменных метательных ножей Синдиката, идеально подходящих для вонзания в тело жертвы. При броске полностью игнорируют броню.
uplink-meds-bundle-name = Медицинский набор Интердайн
...
uplink-ammo-bundle-desc = Перезаряжаю! Содержит 4 магазина для C-20r, 4 барабана для Зауэра и 2 короба патронов для L6 SAW.
...
uplink-clothing-outer-vest-web-elite-desc = Синтетический бронежилет. Несмотря на наличие термостойких волокон плохо защищает от пуль.
...
uplink-eva-syndie-name = Набор ЕВА Синдиката
uplink-eva-syndie-desc = Простой ЕВА-скафандр, который не даёт никакой защиты, кроме той, что необходима для выживания в космосе.
...
uplink-stimpack-desc = Легендарный химический коктейль, производимый компанией Донк Ко. для Синдиката. Одна инъекция этого вещества увеличивает скорость бега и позволяет быстрее восстанавливаться после оглушения в течение 30-ти секунд.
...
uplink-bribe-desc = Подарок от всего сердца, который может помочь вам изменить чьё-то мнение. Настоящие или фальшивые? Да.
