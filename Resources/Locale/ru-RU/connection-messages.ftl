...
ban-banned-permanent = Этот бан можно снять только через апелляцию.
ban-banned-permanent-appeal = Этот бан можно снять только через апелляцию. Подать её можно здесь: { $link }
