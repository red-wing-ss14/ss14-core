...
uplink-autosurgeon-statveka-sandevistan-name = Автооперация (статвека сандевистан)
uplink-autosurgeon-statveka-sandevistan-desc = Заменяет сердце пользователя на статвека-сандевистан — синтетический орган, который резко повышает скорость и реакцию ценой выносливости. В отличие от обычной версии, этот вариант будто замедляет время рядом с пользователем. Поставляется с одноразовой автооперацией для установки.
