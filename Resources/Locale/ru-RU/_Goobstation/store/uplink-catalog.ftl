...
uplink-rifle-mag-desc = 25 патронов 5.56мм калибра. Для Лектера и M-90.
...
uplink-m90-ammo-name = Магазин (5.56мм)
uplink-m90-ammo-desc = 25 патронов 5.56мм калибра. Совместим с M-90 и Лектером.
...
uplink-estoc-ammo-desc = Магазин 5.45мм калибра. Совместим с Эсток.
...
uplink-smugglers-satchel-desc = Прочная сумка, которую можно спрятать под плиткой пола. Просто снимите плитку, прикрепите сумку к покрытию, а затем положите плитку обратно!
