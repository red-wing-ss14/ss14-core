...
job-description-navy-special-operations-officer = Отправляйте, инструктируйте и направляйте Отряды Быстрого Реагирования или другие силы НаноТрейзен. Выдайте ядерные коды или не делайте этого.
...
# Dignitary
job-description-bs = Защищайте и охраняйте командование станции.
job-description-ntr = Представляйте интересы Nanotrasen на станции, следите за соблюдением корпоративных стандартов.
