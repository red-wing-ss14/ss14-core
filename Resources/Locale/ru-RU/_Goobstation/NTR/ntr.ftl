# Основа
store-currency-nt-loyalty-point = Очки лояльности НТ
store-preset-name-ntr = Магазин ПНТ
...
ntr-executive-eva-crate-name = Набор ЕВА
ntr-executive-eva-crate-desc = Ящик с двумя аварийными ЕВА, которые помогут вам и вашим людям выжить в катастрофической ситуации.
ntr-executive-mindshield-crate-name = Ящик имплантов Щит Разума
ntr-executive-mindshield-crate-desc = Ящик с тремя имплантатами "Щит Разума". НаноТрейзен рекомендует в любом случае покупать их в отделе снабжения.
...
ntr-experimental-hardsuit-desc = НаноТрейзен тестирует экспериментальный экокостюм, собранный из блюспейс-проводящих пластин, созданный путём обратной инженерии скафандра Дредноут от CyberSun.
...
ntr-executive-cig-vendor-name = ШейдиСигс премиум
ntr-executive-cig-vendor-desc = Для тех, кто знает, что рака лёгких не существует, НаноТрейзен создала этот торгомат, полный сигарет и дорогих зажигалок, чтобы вы могли курить с комфортом.
